...
The package will be automatically deleted from the server after the game ends`,
	...
	Приносим извинения за доставленные неудобства.`,
		...
		failedToFetch: 'Не удалось отправить запрос на сервер. Проверьте Интернет-соединение, обратитесь к Интернет-провайдеру или учтите возможные региональные ограничения',
...
{0}, сделайте выбор!;{0}, вы выбираете;{0}, вы выбираете следующий вопрос`,
	...
	sr: {
		...
		packageFileWarning: `Otpremanjem paketa na server, preuzimate odgovornost za sadržaj paketa.
		Paket će biti automatski obrisan sa servera nakon završetka igre`,
