...
The package will be automatically deleted from the server after the game ends`,
		...
		replic_Answer: '{0}, what is your answer?;{0}, your answer?;?;{0}, answer!;{0}, I am listening to you;{0}, please, answer',
...
Пакет будет автоматически удалён с сервера после окончания игры`,
		...
		replic_Answer: '{0}, каков же ваш ответ?;{0}, ваш ответ?;?;{0}, отвечайте!;{0}, я вас слушаю;{0}, прошу, отвечайте',
...
{0}, сделайте выбор!;{0}, вы выбираете;{0}, вы выбираете следующий вопрос`,
	...
	sr: {
		...
		questionEditor: 'Pregled pitanja',
		...
		replic_Answer: '{0}, kakav je vaš odgovor?;{0}, vaš odgovor?;?;{0}, odgovarajte!;{0}, slušam vas;{0}, molim, odgovorite',
