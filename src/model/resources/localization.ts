...
The package will be automatically deleted from the server after the game ends`,
		...
		useProxyOnErrors: 'In case of connection errors, try to enable proxy in settings',
...
{0}, сделайте выбор!;{0}, вы выбираете;{0}, вы выбираете следующий вопрос`,
		...
		useProxyOnErrors: 'Если не удаётся подключиться к игре напрямую, попробуйте включить прокси в настройках',
	...
	sr: {
		...
		useProxyOnErrors: 'Ako ne možete direktno da se povežete sa igrom, pokušajte da omogućite proksi u podešavanjima',
