...
const localization = new LocalizedStrings({
	en: {
		...
		autoSearchHint: 'Find a room with an open slot or create a new game',
		avatar: 'Avatar',
		...
		gamesTitle: 'Find a room in the list or create a new game',
		gameType: 'Game type',
	...
	и каждый из игроков письменно сдаёт свой ответ. После этого оглашается правильный ответ, и каждый из игроков получает или теряет деньги.`,
		...
		autoSearchHint: 'Найти комнату со свободным слотом или создать новую игру',
		avatar: 'Аватар',
