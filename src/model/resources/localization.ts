...
const localization = new LocalizedStrings({
	en: {
		...
		siStorageDisclaimer: 'Library packages authors are responsible for the content of the packages, its validity and compliance with the law',
...
The package will be automatically deleted from the server after the game ends`,
	...
	и каждый из игроков письменно сдаёт свой ответ. После этого оглашается правильный ответ, и каждый из игроков получает или теряет деньги.`,
		...
		siStorageDisclaimer: 'Авторы пакетов в библиотеке несут ответственность за содержание пакетов, их достоверность и соответствие закону',
